      ...
      <div className="section-container relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-gradient">SaaS products</span> that actually ship.
          </motion.h1>
          ...
          >
            I design and develop clean, scalable web applications using modern tools, 
            with a strong focus on product thinking and user experience.
          </motion.p>
